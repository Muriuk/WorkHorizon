      ...
      <div className="grid grid-cols-1 lg:grid-cols-[70%,30%] w-full mb-10 py-10 lg:py-20 lg:mb-1">
        <div className='block mb-8 lg:m-0'>
          ...
          <h4 className="text-md 2xl:text-xl font-semibold tracking-wide mb-3 border border-black p-3 rounded-md">
            For employment related queries, try to visit our <Link className="font-bold text-orange-500 capitalize" href={'/careers/jobs'}>Jobs available.</Link>
          </h4>
          ...
          <form className="flex flex-col w-full lg:w-[75%] 2xl:w-[70%]" onSubmit={handleSubmission}>
            <div className='flex flex-col mb-2'>
              ...
              <select className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='reason' required>
                <option className="text-gray-400" value=''>Select the contact option</option>
                {contactOptions.map((option, idx) => <option value={option} key={idx}>{option}</option>)}
              </select>
            </div>
            <div className='flex flex-col mb-2'>
              <label className="text-md lg:text-lg font-[500] tracking-wide mb-1">First name:</label>
              <input type='text' className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='firstname' required placeholder="Enter your firstname" />
            </div>
            <div className='flex flex-col mb-2'>
              <label className="text-md lg:text-lg font-[500] tracking-wide mb-1">Last name:</label>
              <input type='text' className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='lastname' required placeholder="Enter your lastname" />
            </div>
            <div className='flex flex-col mb-2'>
              <label className="text-md lg:text-lg font-[500] tracking-wide mb-1">Email:</label>
              <input type='email' className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='email' required placeholder="Enter your email" />
            </div>
            <div className='flex flex-col mb-2'>
              <label className="text-md lg:text-lg font-[500] tracking-wide mb-1">County:</label>
              <select className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='country' required>
                <option className="text-gray-400" value=''>Select your county</option>
            ...
            <div className='flex flex-col mb-2'>
              ...
              <input className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" type='tel' name="contactnumber" required value={contactNumber} onChange={(e) => handleContactNumber(e.target.value)} placeholder="07XXXXXXXX" />
            </div>
            <div className='flex flex-col mb-2'>
              <label className="text-md lg:text-lg font-[500] tracking-wide mb-1">Message:</label>
              <textarea rows={3} className="bg-gray-100 px-2 py-1 lg:px-4 lg:py-2 border-2 border-gray-200 rounded-lg" name='message' required placeholder="Message..." />
            </div>
        ...
        <div className='flex flex-col justify-center h-fit my-auto border-2 rounded-2xl bg-gray-100 shadow-sm shadow-gray-400'>
          <div className='flex flex-col items-center lg:items-start px-8 py-10 border-b-2'>
            ...
            <Link href={'tel:+254768258491'} className="text-xl 2xl:text-2xl font-bold tracking-wide text-sky-900 border-b border-orange-500">+254768258491</Link>
          </div>
          <div className='flex flex-col items-center lg:items-start px-8 py-10 border-b-2'>
            ...
            <Link href={'mailto:hr@workhorizon.pk'} className="text-xl 2xl:text-2xl font-bold tracking-wide text-sky-900 border-b border-orange-500">info@kazibase.com</Link>
          </div>
          <div className='flex flex-col items-center lg:items-start px-8 py-10'>
            ...
            <Link href={'https://maps.app.goo.gl/8wxyANfpWtUkDN878'} className="text-xl 2xl:text-2xl font-bold tracking-wide text-sky-900 w-fit border-b border-orange-500">Nairobi Kenya</Link>
          </div>
        </div>
      </div>
    </div>

        ...
        <div className="container w-[88%] lg:w-full">
            <div className="mx-auto w-full pt-6 xl:pt-32 pb-16 lg:pb-20 xl:pb-40 grid lg:grid-cols-[50%,50%]">
                <div className="lg:pr-10">
                    ...
                    <h3 className="text-3xl lg:text-5xl font-bold text-sky-900 uppercase lg:leading-tight mb-3 mt-4">
                        Manual Jobs Made Easy in Kenya
                    </h3>
                    <p className="text-md lg:text-xl font-normal tracking-wide">
                        <span className="font-bold bg-gradient-to-r from-sky-400 to-sky-300 bg-clip-text text-transparent">Kazibase</span> ni njia rahisi kwa Wakenya kupata kazi ndogo kama mama fua, fundi, bodaboda, cleaner – au kuajiri mtu wa kusaidia haraka. Unaweka{" "}
                ...
                <div className="flex flex-row justify-center lg:justify-start gap-4 mt-8 lg:col-span-2">
                    <Link href="/postjob">
                        <button className="bg-orange-500 hover:bg-orange-600 text-white font-medium py-2 px-5 rounded-full shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg text-sm sm:text-base flex items-center gap-2">
                    ...
                    <Link href="/login">
                        <button className="bg-sky-900 hover:bg-sky-800 text-white font-medium py-2 px-5 rounded-full shadow-md transition-all duration-300 hover:scale-110 hover:shadow-lg text-sm sm:text-base flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">

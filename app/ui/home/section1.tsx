  ...
  <div className="mx-auto w-full pt-8 xl:pt-24 2xl:pt-32 3xl:pt-40 pb-16 lg:pb-24 xl:pb-32 2xl:pb-40 grid lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20">
    ...
    <div className="flex flex-col justify-center space-y-6 lg:space-y-8 xl:space-y-10">
      ...
      <div className="flex flex-row flex-wrap gap-4 pt-4">
        <Link href="/clientregister">
          <button className="relative overflow-hidden bg-gradient-to-r from-orange-500 to-orange-600 text-white font-medium py-3 px-6 sm:px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group">
        ...
        <Link href="/login">
          <button className="relative overflow-hidden bg-gradient-to-r from-sky-900 to-sky-800 text-white font-medium py-3 px-6 sm:px-8 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group">
            <span className="relative z-10 flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="lg:col-span-2 w-full bg-gradient-to-r from-sky-50 to-orange-50 xl:from-sky-100 xl:to-orange-100 py-16 2xl:py-20 3xl:py-24 rounded-2xl xl:rounded-3xl shadow-lg animate-fadeInUp border-2 border-transparent hover:border-gradient-jobs transition-all duration-700 relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 text-orange-400 animate-float">
        <svg className="w-8 h-8 xl:w-10 xl:h-10" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="absolute bottom-4 left-1/4 text-green-500 animate-float-slow">
        <svg className="w-6 h-6 xl:w-8 xl:h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="text-center relative z-10">
        <h2 className="text-2xl lg:text-4xl xl:text-5xl font-bold text-sky-900 mb-4 xl:mb-6">
          ...
          <div className="inline-block ml-3 animate-bounce">
            <svg className="w-8 h-8 xl:w-10 xl:h-10 text-orange-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.88-.214.33-.403.713-.57 1.116-.334.804-.614 1.768-.84 2.734a31.365 31.365 0 00-.613 3.58 2.64 2.64 0 01-.945-1.067c-.328-.68-.398-1.534-.398-2.654A1 1 0 005.05 6.05 6.981 6.981 0 003 11a7 7 0 1011.95-4.95c-.592-.591-.98-.985-1.348-1.467-.363-.476-.724-1.063-1.207-2.03zM12.12 15.12A3 3 0 017 13s.879.5 2.5.5c0-1 .5-4 1.25-4.5.5 1 .786 1.293 1.371 1.879A2.99 2.99 0 0113 13a2.99 2.99 0 01-.879 2.121z" clipRule="evenodd"/>
            </svg>
          </div>
        </h2>
        <p className="text-lg lg:text-xl xl:text-2xl text-gray-700 mb-8 xl:mb-10 px-4 lg:px-8">
        ...
        <Link href="/jobspage">
          <button className="bg-gradient-to-r from-sky-900 to-orange-500 hover:from-sky-800 hover:to-orange-600 text-white font-bold py-3 px-8 xl:py-4 xl:px-10 rounded-full shadow-xl transition-all duration-500 hover:scale-110 hover:shadow-2xl text-lg xl:text-xl flex items-center gap-3 mx-auto glow-jobs hover:glow-jobs-intense animate-slideInFromBottom animate-delay-600 relative overflow-hidden group">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 xl:h-6 xl:w-6 animate-spin-slow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
            </svg>
            <span className="relative">
              View All Jobs
            </span>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 xl:h-6 xl:w-6 animate-pulseBounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">

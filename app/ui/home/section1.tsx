...
export default function HomeHead() {
        ...
        <div className="container w-[88%] lg:w-full 2xl:w-[85%] 3xl:w-[80%] 4xl:w-[75%] 5xl:w-[70%]">
            <div className="mx-auto w-full pt-6 xl:pt-32 2xl:pt-36 3xl:pt-40 4xl:pt-44 5xl:pt-48 pb-16 lg:pb-20 xl:pb-40 2xl:pb-44 3xl:pb-48 4xl:pb-52 5xl:pb-56 grid lg:grid-cols-[50%,50%] 2xl:grid-cols-[45%,55%] 3xl:grid-cols-[40%,60%]">
                ...
                <div className="lg:pl-12 2xl:pl-16 3xl:pl-20 4xl:pl-24 5xl:pl-28 pt-5 2xl:pt-7 3xl:pt-9">
                    <p className="text-md lg:text-xl 2xl:text-2xl 3xl:text-3xl 4xl:text-4xl 5xl:text-5xl font-normal tracking-wide 2xl:tracking-wider 3xl:tracking-widest">
                        All workers <span className="text-orange-400 font-semibold">verify</span> their skills. This means you can trust their work.{" "}
  ...
  {/* Login as a Worker Button */}
  <Link href="/login">
    <button className="bg-sky-900 hover:bg-sky-800 text-white font-medium py-2 px-6 2xl:py-3 2xl:px-8 3xl:py-4 3xl:px-10 4xl:py-5 4xl:px-12 5xl:py-6 5xl:px-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl text-sm sm:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl flex items-center gap-2 2xl:gap-3 3xl:gap-4 glow-sky hover:glow-sky-intense">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 2xl:h-5 2xl:w-5 3xl:h-6 3xl:w-6 4xl:h-7 4xl:w-7 5xl:h-8 5xl:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
      </svg>
      Login as a worker
  ...
  <Link href="/">
    <button className="bg-orange-600 hover:bg-orange-500 text-white font-medium py-2 px-6 2xl:py-3 2xl:px-8 3xl:py-4 3xl:px-10 4xl:py-5 4xl:px-12 5xl:py-6 5xl:px-14 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl text-sm sm:text-base 2xl:text-lg 3xl:text-xl 4xl:text-2xl 5xl:text-3xl flex items-center gap-2 2xl:gap-3 3xl:gap-4 glow-orange hover:glow-orange-intense">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 2xl:h-5 2xl:w-5 3xl:h-6 3xl:w-6 4xl:h-7 4xl:w-7 5xl:h-8 5xl:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">

...
export default function AboutSection () {
    ...
    return(
        <div className="my-14 xl:my-28 mx-auto w-[88%] lg:w-full overflow-x-hidden container">
            <h3 className="text-3xl xl:text-4xl capitalize text-sky-900 font-bold mb-3" data-aos='fade-up'>More Than a Job Board – Empowering Kenya's Hustlers</h3>
            <p className="text-md lg:text-xl font-normal tracking-wide" data-aos='fade-up'>
                At <span className="text-orange-500 font-semibold uppercase">Kazibase</span>, we're not just another job platform—we’re a bridge connecting everyday Kenyans to real opportunities. Whether you’re a hustler offering manual services or someone in need of help, Kazibase makes it easy to connect, collaborate, and thrive.
            </p>
            <div className="flex flex-col lg:grid lg:grid-cols-[45%,55%] my-5 w-full">
                ...
                <div className="lg:pl-8 lg:pr-3 flex flex-col justify-start pt-10 lg:py-16" data-aos='fade-up xl:fade-left' data-aos-duration='700'>
                    ...
                    <p className="text-md lg:text-xl font-normal tracking-wide mt-6">
                        Whether you're a fundi, mama fua, painter, or boda rider, we help you get noticed and get hired—quickly, safely, and directly through your phone.
                    </p>

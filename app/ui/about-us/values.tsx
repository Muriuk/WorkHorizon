    ...
    const values = [
        {
            ...
            tagline: 'Commitment to delivering high-quality service and continuous improvement for hustlers across Kenya.',
        },{
            title:'Innovation',
            icons: '/assets/icons/about/innovation.png',
            tagline: 'Leveraging cutting-edge technology and creative strategies to enhance manual job opportunities.',
        },{
            title:'Integrity',
            ...
            tagline: 'Fostering teamwork and strong partnerships with hustlers and clients.',
        },{
    ...
    return(
        <div className='container w-[88%] lg:w-full flex flex-col items-center mb-10 lg:m-auto' >
            <div className='shadow-lg shadow-gray-300 rounded-2xl px-3 lg:px-8 w-full py-10 lg:py-14 bg-gray-300' data-aos='fade-up'>
                <h3 className='text-3xl lg:text-5xl font-bold text-sky-900 uppercase lg:leading-tight mb-3 '>Values That Shape Success at Kazibase</h3>
                <p className="text-lg lg:text-2xl">Kazibase believes that embedding core values across the platform fuels collaboration, productivity, and long-term growth for hustlers in Kenya.</p>
            </div>
            <div className='py-10 lg:py-14 flex flex-col flex-wrap 2xl:flex-nowrap lg:flex-row lg:justify-center gap-10' data-aos='fade-up'>
                {
                    ...
                    <div className={`flex flex-col items-center mx-auto lg:mx-0 w-[70%] lg:w-1/4 2xl:w-1/5 border border-sky-900 py-5 px-4 rounded-2xl text-center shadow-xl shadow-gray-200`} key={idx}>
                        <Image src={value.icons} className="w-[7rem] h-auto" alt={`${value.title}'s icon - Kazibase`} width={100} height={100} />

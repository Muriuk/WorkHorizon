...
export default function DashboardBody() {
    ...
    const IconComponent = ({ type, className = "w-5 h-5" }) => {
        const icons = {
            home: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-12 0h3m0 0v-8a1 1 0 011-1h3v10m9-10h3v8a1 1 0 01-1 1h-3" />,
            search: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />,
            document: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />,
                    ...
                    {activeSection !== 'dashboard' && activeSection !== 'jobs' && (
                        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center">
                            <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                <IconComponent type={sidebarItems.find(item => item.key === activeSection)?.icon || 'home'} className="w-8 h-8 text-slate-500" />
                            </div>
